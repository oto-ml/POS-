...
export const MENU_ITEMS: MenuItem[] = [
  {
    ...
    stock: 50 // Añadido stock por defecto para compatibilidad
  },
  {
    id: '2',
...
export const MOCK_ORDERS: Order[] = [
  {
    ...
    // customerEmail no existe en la interfaz Order actual, lo comentamos o removemos
...
export const KITCHEN_TICKETS = [
  {
    ...
    elapsedTime: '05:32',
    items: [
      { id: 'tmp-1', price: 0, category: 'Platos Fuertes', image: '', stock: 0, name: 'Hamburguesa Clásica', quantity: 2, notes: 'Sin cebolla' },
      { id: 'tmp-2', price: 0, category: 'Entradas', image: '', stock: 0, name: 'Papas Fritas', quantity: 1 },
      { id: 'tmp-3', price: 0, category: 'Bebidas', image: '', stock: 0, name: 'Refresco de Cola', quantity: 1 },
    ],
    status: 'high'
  },
  // ... (otros tickets pueden simplificarse si no se usan directamente con tipos estrictos)
];